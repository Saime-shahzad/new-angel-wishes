...
import medicaltestreports from "../../assets/images/medicaltestreports.png";
import storyStream from "../../assets/images/storyStream.png";
import lifeCarePlans from "../../assets/images/lifeCarePlans.png";
import lifeSustainingPlans from "../../assets/images/lifeSustainingPlans.png";
import journyWishes from "../../assets/images/journyWishes.png";
import favouriteJames from "../../assets/images/favouriteJames.png";
import guardianShip from "../../assets/images/guardianShip.png";
...
const Dashboard = () => {
  ...
  const handleSelectValue = (newValue) => {
    if (newValue) {
      // Ensure newValue and target are defined
  ...
  const cardDetail = [
    {
      ...
      isAllow: true,
      image: familyIcon,
      folderName: "Sanp Shots",
      routes: "/memories-folder",
    },
    {
      id: "2",
      isAllow: true,
      image: favouriteJames,
      folderName: "Favorite james",
      routes: "/",
    },
    {
      id: "3",
      isAllow: true,
      image: storyStream,
      folderName: "story stream ",
      routes: "/vediosMemories",
    },
    {
      id: "4",
      isAllow: true,
      image: journyWishes,
      folderName: "Journey of wishes",
      routes: "/memories-folder",
    },
    {
      id: "5",
    ...
    },
    {
      ...
      isAllow: true,
      image: lifeCarePlans,
      folderName: "Life Care Planes",
      routes: "/",
    },
    {
      id: "7",
      isAllow: true,
      image: lifeSustainingPlans,
      folderName: "Life sustaining olders",
      routes: "/memories-folder",
    },
    {
      id: "8",
      isAllow: true,
      image: medicaltestreports,
      folderName: "Medical Test Report",
      routes: "/",
    },
    {
      id: "9",
              ...
              <Box sx={{ pb: 1 }}>
                ...
                >
                  ...
                  <Selects
                    ...
                    iconName={icons.createNewFolderIcons}
                  />
                  <Box
                    sx={{
                      display: "flex",
